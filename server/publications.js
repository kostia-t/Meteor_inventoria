...
Meteor.publish('resources.all', function(query, filter, limit) {
...
Meteor.publish('colors.all', function(query, filter, limit) {
...
Meteor.publish('tags.all', function(query, filter, limit) {
...
Meteor.publish('profilePhotos.all', function(query, filter, limit) {
